...
import { LogOut, LayoutDashboard, User as UserIcon, Settings, ChevronDown, Sparkles, X } from 'lucide-react';
          ...
          >
            <div className="p-4 border-b border-gray-100 bg-orange-50/50 relative">
              <button 
                ...
                className="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-gray-700 bg-white/50 hover:bg-white rounded-full transition-colors"
              >
                <X size={16} />
              </button>
            ...
            <div className="p-2 space-y-1">
              <Link 
                ...
                className={`flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-xl transition-colors ${location.pathname === '/dashboard' ? 'bg-orange-100 text-orange-600' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600'}`}
              >
              ...
              <Link 
                to="/workspace" 
                onClick={() => setIsOpen(false)}
                className={`flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-xl transition-colors ${location.pathname === '/workspace' ? 'bg-orange-100 text-orange-600' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600'}`}
              >
                <Sparkles size={18} />
                Workspace
              </Link>
